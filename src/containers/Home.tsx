    ...
    useEffect(() => {
        if (client && viewkey) {
            ...
            setInterval(() => {
                getConfigsTrigger(client)
                getPaginatedUserTicketsTrigger(client, viewkey, paginationValues.page, paginationValues.page_size)
            },30000); // check every second if we are at the 30 seconds or 0 seconds of every minute, then trigger
        }
    }, [client, viewkey])
    ...
    return (
        <div>
            <div style={{ color: "white", width: "100%" }}>
                {
                    !currentRoundsState && <i className="fa fa-spinner fa-spin" style={{ color: "white" }}></i>
                }
                {
                    currentRoundsState &&
                                    ...
                                    </Row>
                                    {
                                        ...
                                        <React.Fragment>
                                            <Row>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_6 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col xs={7}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_5 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col xs={7}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_4 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col xs={7}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_3 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col xs={7}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_2 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col xs={7}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.sequence_1 * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <br />
                                            <Row>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.burn * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                            <Row style={{ marginBottom: "10px" }}>
                                                ...
                                                <Col style={{ textAlign: "left" }}>
                                                    {`${formatNumber(parseInt(currentRoundsState.running_pot_size) * (configs.prize_pool_allocations.triggerer * 0.01) / 1000000)} SEFI`}
                                                </Col>
                                            </Row>
                                        </React.Fragment>
                                    }
